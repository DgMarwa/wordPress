...
$wp_customize->add_setting( 'omega_storefront_copyright_alignment', array(
    'default'           => 'Default',
    'capability'        => 'edit_theme_options',
    'sanitize_callback' => 'omega_storefront_sanitize_copyright_alignment_meta',
) );

$wp_customize->add_control( 'omega_storefront_copyright_alignment', array(
    'label'    => esc_html__( 'Copyright Section Alignment', 'omega-storefront' ),
    'section'  => 'omega_storefront_footer_widget_area',
    'type'     => 'select',
    'choices'  => array(
        'Default' => esc_html__( 'Default View', 'omega-storefront' ),
        'Reverse' => esc_html__( 'Reverse View', 'omega-storefront' ),
        'Center'  => esc_html__( 'Centered Content', 'omega-storefront' ),
    ),
) );
...
$wp_customize->add_control( 'omega_storefront_to_the_top_text',
    array(
    'label'    => esc_html__( 'Edit Text Here', 'omega-storefront' ),
    'section'  => 'omega_storefront_footer_widget_area',
    'type'     => 'text',
    )
);