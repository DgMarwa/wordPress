...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<?php if ( get_theme_mod('omega_storefront_display_single_post_image', true) == true ) : ?>
		<?php if( is_single() && 'post' === get_post_type() ) {
			...
			if ( has_post_thumbnail() ) { // If the post has a featured image
				...
				?>
				<div class="post-thumbnail">
					<img src="<?php echo esc_url( get_template_directory_uri() . '/inc/homepage-setup/assets/homepage-setup-images/Product-Name-Here-2.png' ); ?>" alt="<?php esc_attr_e( 'Omega Storefront Default Image', 'omega-storefront' ); ?>" />
				</div>
				<?php
			}
		} else { 
